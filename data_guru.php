...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into data_guru values ('$nip', '$nama_guru','$kelamin','$alamat_guru','$telpon_guru','$username','$password')");
		...
		?>
            <tr>
              ...
              <td class="options-width">
                <a href="?page=delete_guru&nip=<?php echo $row['nip'] ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm ('Apakah anda yakin akan menghapus data guru ini ?')"></a>
                <a href="?page=edit_guru&nip=<?php echo $row['nip'] ?>" title="Edit" class="icon-5 info-tooltip"></a>
              </td>
            </tr>
            <?php
		}
