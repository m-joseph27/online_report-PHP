...
<tr>
    ...
    <div id="content-table-inner">
        ...
        <?php
		      $view=mysqli_query($koneksi, "select * from tbl_ruangan id_ruangan, setup_kelas id_kelas, data_siswa id_siswa where id_ruangan.id_kelas=kelas.id_kelas and id_ruangan.id_siswa=siswa.id_siswa order by id_ruangan asc");
        ...
        <tr>
          ...
          <td class="options-width">
            <a href="?page=delete_ruang_kelas&id_ruangan=<?php echo $row['id_ruangan'] ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm ('Apakah anda yakin akan menghapus jadwan kelas ini ?')"></a>
            <a href="?page=edit_ruang_kelas&id_ruangan=<?php echo $row['id_ruangan'] ?>" title="Edit" class="icon-5 info-tooltip"></a>   
          </td>
        </tr>
		<?php
		}
