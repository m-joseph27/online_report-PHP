...
if(isset($_POST['submit'])){
  ...
  $nis=ucwords($_POST['nis']);
	...
	$telpon_siswa=ucwords(htmlentities($_POST['telpon_siswa']));
	$username=ucwords($_POST['username']);
	$password=md5(ucwords($_POST['password']));
	
	$query=mysqli_query($koneksi,"insert into data_siswa values ('$nis','$nama_siswa','$kelamin','$alamat_siswa','$telpon_siswa','$username','$password')");
    ...
    <div id="content-table-inner">
      <?php
		...
		<tr>
            ...
            <a href="?page=delete_siswa&nis=<?php echo $row['nis'] ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm ('Apakah anda yakin akan menghapus data siswa ini ?')"></a>
            <a href="?page=edit_siswa&nis=<?php echo $row['nis'] ?>" title="Edit" class="icon-5 info-tooltip"></a>            
            </td>
        </tr>
		<?php
		}
