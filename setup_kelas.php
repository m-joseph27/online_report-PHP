...
<tr>
    ...
    <div id="content-table-inner">
		...
		<tr>
            ...
            <a href="?page=delete_kelas&id_kelas=<?php echo $row['id_kelas']?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm ('Apakah anda yakin akan menghapus data kelas ini ?')"></a>
            <a href="?page=edit_kelas&id_kelas=<?php echo $row['id_kelas'] ?>" title="Edit" class="icon-5 info-tooltip"></a>            
            </td>
        </tr>
		<?php
		}
